...
namespace Sage.BusinessRules.CodeSnippets
{
    ...
    public static partial class SalesOrderDetailsEventHandlers
    {
        ...
        public static void OnLoad1Step(ISalesOrderDetails form, EventArgs args)
        {
			...
			form.QFSLXPickList.PickListValue = salesOrder.ComplementCommande.MODEREGLEMENT1;
			form.QFSLXPickList2.PickListValue = salesOrder.ComplementCommande.MODEREGLEMENT2;
			form.QFSLXPickList3.PickListValue = salesOrder.ComplementCommande.MODEREGLEMENT3;
