        ...
        startup: function () {
            ...
            switch (this.valueRangeKind) {
                ...
                case enumerations.SlxParameterValueRangeKind.DiscreteAndRange:
                    ...
                    if (this._values.length > 0) {
                        crystalReportsUtility.initializeComboBoxValues(this._values, crystalReportsUtility.getRangeInitialValue(this._initialValues, true), this.cboDiscreteStartRange);
                        ...
                        crystalReportsUtility.initializeComboBoxValues(this._values, crystalReportsUtility.getRangeInitialValue(this._initialValues, false), this.cboEndRangeValues);
