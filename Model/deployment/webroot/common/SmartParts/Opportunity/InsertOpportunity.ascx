...
var value = Sage.SalesLogix.BusinessRules.BusinessRuleHelper.GetPickListValueByCode("Account Partner", "Reseller");
if (!String.IsNullOrEmpty(value))
{
    lueReseller.SeedValue = value;
}
value = Sage.SalesLogix.BusinessRules.BusinessRuleHelper.GetPickListValueByCode("Lead Source Status", "A");
if (!String.IsNullOrEmpty(value))
{
