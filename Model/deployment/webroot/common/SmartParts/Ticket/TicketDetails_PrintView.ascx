...
<asp:Label runat="server" ID="QFCA12MOIS" style="white-space:normal"  />
  </div>
...
<asp:Label runat="server" ID="emlAssignToEmail" />
 ...
 <div class=" lbl alignleft" style="margin-top:.5em;">
  ...
  <div  class="textcontrol"  style="margin-top:.5em;" >
<asp:Label runat="server" ID="QFREF" style="white-space:normal"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
  ...
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="QFNCDE" LookupEntityName="SalesOrder" LookupEntityTypeName="Sage.Entity.Interfaces.ISalesOrder, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="Text" LookupBindingMode="String" SeedProperty="Account.Id" EnableHyperLinking="true" InitializeLookup="true" Required="true" AllowClearingResult="true" OverrideSeedOnSearch="true"  >
<LookupProperties>
...
<LookupPreFilters>
 ...
 <div class=" lbl alignleft" style="margin-top:.5em;">
  ...
  <div  class="textcontrol"  style="margin-top:.5em;" >
<asp:Label runat="server" ID="QFPrefixe" style="white-space:normal"  />
  </div>
 ...
 <div class=" lbl alignleft" style="margin-top:.5em;">
  ...
  <div  class="textcontrol"  style="margin-top:.5em;" >
<asp:Label runat="server" ID="QFLIGNECDE" style="white-space:normal"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" style="margin-top:.5em;">
  ...
  <div  class="textcontrol"  style="margin-top:.5em;" >
<asp:Label runat="server" ID="QFNUMEROBL" style="white-space:normal"  />
  </div>
 ...
 <div class=" lbl alignleft" style="margin-top:.5em;">
  ...
  <div  class="textcontrol"  style="margin-top:.5em;" >
<asp:Label runat="server" ID="QFNFACTURE" style="white-space:normal"  />
  </div>
...
LabelPlacement="left" AutoPostBack="true"  />
 ...
 <div class=" lbl alignleft" style="margin-top:.5em;">
  ...
  <div  class="textcontrol"  style="margin-top:.5em;" >
<asp:Label runat="server" ID="QFASSCO" style="white-space:normal"  />
  </div>
...
<div style="height: 100%;width: 100%">
 ...
 <table border="0" cellpadding="1" cellspacing="0" class="slx-tab-panel">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFRECEPTIONACHAT" DisplayTime="false" DisplayMode="AsText" />
  </div>
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFTRAITEMENTACHAT" DisplayTime="false" DisplayMode="AsText" />
  </div>
...
<SalesLogix:TabPanel data-dojo-type="Sage.Layout.ContentPane" ID="QFDATESSUIVI_Page_2" runat="server"  TabCaption="<%$ resources: QFDATESSUIVI_Page_2.Caption %>"  >
 <table border="0" cellpadding="1" cellspacing="0" class="slx-tab-panel">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFRECEPTIONCOMPTA" DisplayTime="false" DisplayMode="AsText" />
  </div>
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFTRAITEMENTCOMPTA" DisplayTime="false" DisplayMode="AsText" />
  </div>
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFCLOTURECOMPTA" DisplayTime="false" DisplayMode="AsText" />
  </div>
...
public class TicketDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.ITicketDetails
{
    ...
    private Sage.Platform.Controls.IMultiTabControl _QFDATESSUIVI;
    ...
    public  void OnLoad1(System.EventArgs e)
    {
        ...
        lib.Execute("TicketDetails.OnLoad1", methodArgs);
    }
    ...
    public  void QFPAPIER_OnChange(System.EventArgs e)
    {
        Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
        Object[] methodArgs = new Object[] { this, e };
        lib.Execute("TicketDetails.QFPAPIER_OnChange", methodArgs);
    }
    public  void cmdSave_OnClick(System.EventArgs e)
    {
        Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
        Object[] methodArgs = new Object[] { this, e };
        lib.Execute("TicketDetails.cmdSave_OnClick", methodArgs);
    }
}
