...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
 ...
 <div class=" lbl alignleft">
   <asp:Label ID="QFORIGINE_lbl" AssociatedControlID="QFORIGINE" runat="server" Text="<%$ resources: QFORIGINE.Caption %>" ></asp:Label>
 </div>   
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFORIGINE" PickListName="C_SOCIETES" AutoPostBack="true" MustExistInList="false" AllowMultiples="true" MaxLength="64"  />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="QFSTART_lbl" AssociatedControlID="QFSTART" runat="server" Text="<%$ resources: QFSTART.Caption %>" ></asp:Label>
 </div>
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFSTART" DisplayTime="false" />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="QFEND_lbl" AssociatedControlID="QFEND" runat="server" Text="<%$ resources: QFEND.Caption %>" ></asp:Label>
 </div>
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="QFEND" DisplayTime="false" />
  </div>
...
<tr>
 ...
 <div class="twocollbl alignleft">
   <asp:Label ID="QFGAMME_lbl" AssociatedControlID="QFGAMME" runat="server" Text="<%$ resources: QFGAMME.Caption %>" ></asp:Label>
 </div>   
   <div  class="twocoltextcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFGAMME" PickListName="C_GAMME" MustExistInList="false" MaxLength="64"  />
  </div>

      </td>
                      <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="QFReference_lbl" AssociatedControlID="QFReference" runat="server" Text="<%$ resources: QFReference.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFReference"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 AllowPaging="true" PageSize="20" OnPageIndexChanging="grdTHistoriqueLignesDeVentesspage_changing"  ExpandableRows="True" ResizableColumns="True"  OnRowCommand="grdTHistoriqueLignesDeVentess_RowCommand"
 ...
 <asp:ButtonField CommandName="Edit"
  Text="<%$ resources: grdTHistoriqueLignesDeVentess.936a2c1b-cd66-4938-95df-fbf3efddbde1.Text %>"               >
    ...
    <asp:BoundField DataField="LIVRAISONREELLE"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.4d0c89bd-b3b4-4c87-b405-75af1c367788.ColumnHeading %>"       SortExpression="LIVRAISONREELLE"    >
      </asp:BoundField>
    ...
    <asp:BoundField DataField="NBCOLIS"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.abf6ba01-c710-4b55-a8bd-ef279a943502.ColumnHeading %>"       SortExpression="NBCOLIS"    >
      </asp:BoundField>
 </Columns>
...
protected void grdTHistoriqueLignesDeVentesspage_changing(object sender, GridViewPageEventArgs e)
{
 grdTHistoriqueLignesDeVentess.PageIndex = e.NewPageIndex;
...
protected override void OnAddEntityBindings() {
   ...
   dsTHistoriqueLignesDeVentess.BindFieldNames = new String[] { "Id","Date_piece","Num_commande","Code_article","GAMME","Quantite_commandee","Quantite_livree","RAE","Prix_unitaire","Couleurs_recto","Couleurs_verso","Montant_ht","Date_livraison_prevue","LIVRAISONREELLE","ORIGINE","NBCOLIS" };
        
     BindingSource.OnCurrentEntitySet += new EventHandler(dsTHistoriqueLignesDeVentess_OnCurrentEntitySet);
    
}
                                                 
protected void QFORIGINE_ChangeAction(object sender, EventArgs e) {
Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
Object[] methodArgs = new Object[] { FormAdapter, e };
lib.Execute("histoventessp.QFORIGINE_OnChange", methodArgs);

}
protected void QFButton_ClickAction(object sender, EventArgs e) {
if (DialogService != null) {
  // DialogActionItem
  DialogService.SetSpecs(400, 600, "histoventes", string.Empty );
...
protected override void OnWireEventHandlers()
{
 ...
 QFORIGINE.PickListValueChanged += new EventHandler(QFORIGINE_ChangeAction);
QFButton.Click += new EventHandler(QFButton_ClickAction);
QFButton.Click += new EventHandler(DialogService.CloseEventHappened);
QFButton.Click += new EventHandler(Refresh);
...
Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
Object[] methodArgs = new Object[] { FormAdapter, e };
lib.Execute("histoventessp.OnLoad1", methodArgs);
...
public class histoventesspAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.Ihistoventessp
{
    ...
    private Sage.Platform.Controls.IPickListControl _QFORIGINE;
    public  Sage.Platform.Controls.IPickListControl QFORIGINE
    {
        get { return FindControl(ref _QFORIGINE, "QFORIGINE"); }
    }
    private Sage.Platform.Controls.IPickListControl _QFGAMME;
    public  Sage.Platform.Controls.IPickListControl QFGAMME
    {
        get { return FindControl(ref _QFGAMME, "QFGAMME"); }
    }
    ...
    private Sage.Platform.Controls.IDateTimePickerControl _QFSTART;
    public  Sage.Platform.Controls.IDateTimePickerControl QFSTART
    {
        get { return FindControl(ref _QFSTART, "QFSTART"); }
    }
    ...
    private Sage.Platform.Controls.IDateTimePickerControl _QFEND;
    public  Sage.Platform.Controls.IDateTimePickerControl QFEND
    {
        get { return FindControl(ref _QFEND, "QFEND"); }
    }
    private Sage.Platform.Controls.ITextBoxControl _QFReference;
    public  Sage.Platform.Controls.ITextBoxControl QFReference
    {
        get { return FindControl(ref _QFReference, "QFReference"); }
    }
    ...
    public  void QFORIGINE_OnChange(System.EventArgs e)
    {
        Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
        Object[] methodArgs = new Object[] { this, e };
        lib.Execute("histoventessp.QFORIGINE_OnChange", methodArgs);
