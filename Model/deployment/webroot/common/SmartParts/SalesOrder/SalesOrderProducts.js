...
{
		field: 'Family',
				name:  SalesOrderProductsgrdItems_Strings['grdItems_6210cd5f_3e9d_40cf_8b1d_f8c15476cc79_ColumnHeading']  || 'Family',
	sortable: false,
		width: 0,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
      ...
      structure : [
     {
       ...
       cells: [
		...
		return anchor;
		 ...
		 {
		   name: SalesOrderProductsluProduct_Strings['luProduct_LookupProperties_Name_PropertyHeader']  || 'Nom',
		   field: 'Name',
         ...
         ,
		 {
		   name: SalesOrderProductsluProduct_Strings['luProduct_LookupProperties_Family_PropertyHeader']  || 'Famille',
		   field: 'Family',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 12,
         ...
         ,
		 {
		   name: SalesOrderProductsluProduct_Strings['luProduct_LookupProperties_Status_PropertyHeader']  || 'Etat',
		   field: 'Status',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 12,
         ...
         ,
		 {
		   name: SalesOrderProductsluProduct_Strings['luProduct_LookupProperties_ActualId_PropertyHeader']  || 'ID réel',
		   field: 'ActualId',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 12,
