...
<SalesLogix:LookupControl runat="server" ID="lueAccount" ButtonToolTip="<%$ resources: lueAccount.ButtonToolTip %>" LookupEntityName="Account" LookupEntityTypeName="Sage.Entity.Interfaces.IAccount, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" EnableHyperLinking="true" AutoPostBack="true" AddEmptyListItem="false"  >
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAccount.LookupProperties.AccountName.PropertyHeader %>" PropertyName="AccountName" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="True"></SalesLogix:LookupProperty>
...
Enabled="false" Visible="false" >
  ...
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="lueCurrencyCode" ButtonToolTip="<%$ resources: lueCurrencyCode.ButtonToolTip %>" LookupEntityName="ExchangeRate" LookupBindingMode="String" AutoPostBack="true" AddEmptyListItem="false" LookupImageURL="~/ImageResource.axd?scope=global&type=Global_Images&key=Find_16x16"  >
<LookupProperties>
...
Enabled="false" >
    <div    >
<SalesLogix:LookupControl runat="server" ID="lueERPApplication" ButtonToolTip="<%$ resources: lueERPApplication.ButtonToolTip %>" LookupEntityName="AppIdMapping" LookupEntityTypeName="Sage.Entity.Interfaces.IAppIdMapping, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="DropDownList" DropDownDisplayProperty="Name" AutoPostBack="true" AddEmptyListItem="false" Visible="false" DialogTitle="<%$ resources: lueERPApplication.LookupDialogTitle %>"  >
<LookupProperties>
...
<SalesLogix:LookupPreFilter PropertyName="IsUserEndpoint" PropertyType="System.Boolean" OperatorCode="=" Visible="False"
 ...
 <div class="lblright alignleft">
   <asp:Label ID="lueERPApplication_lbl" AssociatedControlID="lueERPApplication" runat="server" Text="<%$ resources: lueERPApplication.Caption %>" Visible="false" ></asp:Label>
 </div>   
  ...
  <div    >
<SalesLogix:LookupControl runat="server" ID="luePriceList" ButtonToolTip="<%$ resources: luePriceList.ButtonToolTip %>" Enabled="false" LookupEntityName="SlxPriceList" LookupEntityTypeName="Sage.Entity.Interfaces.ISlxPriceList, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="DropDownList" SeedProperty="AppId" DropDownDisplayProperty="Name" AutoPostBack="true" AddEmptyListItem="false" DialogTitle="<%$ resources: luePriceList.LookupDialogTitle %>" OverrideSeedOnSearch="true"  >
<LookupProperties>
...
Visible="false" >
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFSLXPickList2"  ToolTip="<%$ resources: QFSLXPickList2.ToolTip %>" PickListName="CompteModereglement" MustExistInList="false"  />
  </div>
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFTextBox5" ToolTip="<%$ resources: QFTextBox5.ToolTip %>"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
Visible="false" >
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFSLXPickList"  ToolTip="<%$ resources: QFSLXPickList.ToolTip %>" PickListName="CompteModereglement" MustExistInList="false"  />
  </div>
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFTextBox4" ToolTip="<%$ resources: QFTextBox4.ToolTip %>"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
Visible="false" >
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFSLXPickList3"  ToolTip="<%$ resources: QFSLXPickList3.ToolTip %>" PickListName="CompteModereglement" MustExistInList="false"  />
  </div>
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFTextBox6" ToolTip="<%$ resources: QFTextBox6.ToolTip %>"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
 ...
 <div class=" lbl alignleft">
  ...
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="lueRequestedBy" ButtonToolTip="<%$ resources: lueRequestedBy.ButtonToolTip %>" LookupEntityName="Contact" LookupEntityTypeName="Sage.Entity.Interfaces.IContact, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" SeedProperty="Account.Id" InitializeLookup="true" AllowClearingResult="true" Visible="false" OverrideSeedOnSearch="true"  >
<LookupProperties>
...
<tr>
 ...
 <div class=" lbl alignleft">
  ...
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="lueOpportunity" ButtonToolTip="<%$ resources: lueOpportunity.ButtonToolTip %>" LookupEntityName="Opportunity" LookupEntityTypeName="Sage.Entity.Interfaces.IOpportunity, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" SeedProperty="Account.Id" EnableHyperLinking="true" InitializeLookup="true" AutoPostBack="true" AllowClearingResult="true" Visible="false"  >
<LookupProperties>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFTextBox"  dojoType="Sage.UI.Controls.TextBox" Visible="false"  />
  </div>
...
Visible="false" LabelPlacement="left"  />
</div>
      </td>
      </tr>
</table>
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox1TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.NDOSSIER", QFTextBox1, "Text");
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox8TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.VISAADV", QFTextBox8, "Text");
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFSLXPickList2PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.MODEREGLEMENT2", QFSLXPickList2, "PickListValue");
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFSLXPickListPickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.MODEREGLEMENT1", QFSLXPickList, "PickListValue");
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBoxTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.CENTREPAYEUR", QFTextBox, "Text");
...
Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
Object[] methodArgs = new Object[] { FormAdapter, e };
lib.Execute("InsertSalesOrder.OnLoad2", methodArgs);
