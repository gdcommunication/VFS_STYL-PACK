...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 ...
 OnRowEditing="grdTHistoriqueLignesDeVentess_RowEditing" >
<Columns>
 <asp:ButtonField CommandName="Edit"
  Text="<%$ resources: grdTHistoriqueLignesDeVentess.936a2c1b-cd66-4938-95df-fbf3efddbde1.Text %>"               >
      ...
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.374eb228-caed-44f1-8a4d-e268a1ccb1ef.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Num_commande"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.abafaf16-a1cc-47f1-8dd4-d36df7a4e0e5.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Code_article"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.3ade809d-362e-4570-a22b-0601f4668a3f.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Quantite_commandee"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.9140ab27-3a00-46ff-aebb-e2b8377f3aef.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Quantite_livree"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.d0503d81-811b-4adc-bf60-ada0c7bb515c.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="RAE"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.3190a479-d4a0-4f66-a8f2-d6e5c8315f49.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Prix_unitaire"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.1c96a3d0-814b-457f-a982-a8dba5ac6d14.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Couleurs_recto"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.f5d9c291-21f2-4edb-9df3-99a03fe3432d.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Couleurs_verso"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.4c77b9a9-0f3a-4f25-815f-1dffcd7d4386.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Montant_ht"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.472e74b5-d4c9-4653-bcbc-80d2fdf81017.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Date_livraison_prevue"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.2a814aee-f73b-46af-a097-634bfb288383.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="ORIGINE"
      HeaderText="<%$ resources: grdTHistoriqueLignesDeVentess.c034fd3f-e347-480d-8f10-bf0817db4b6b.ColumnHeading %>"          >
      </asp:BoundField>
 </Columns>
...
protected override void OnAddEntityBindings() {
   ...
   dsTHistoriqueLignesDeVentess.BindFieldNames = new String[] { "Id","Date_piece","Num_commande","Code_article","Quantite_commandee","Quantite_livree","RAE","Prix_unitaire","Couleurs_recto","Couleurs_verso","Montant_ht","Date_livraison_prevue","ORIGINE" };
