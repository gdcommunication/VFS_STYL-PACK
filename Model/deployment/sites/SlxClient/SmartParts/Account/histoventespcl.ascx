...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 AllowPaging="true" PageSize="20" OnPageIndexChanging="grdTHISTOPCLSpage_changing"  ExpandableRows="True" ResizableColumns="True"  OnRowCommand="grdTHISTOPCLS_RowCommand"
 DataKeyNames="InstanceId,Id"
 OnRowEditing="grdTHISTOPCLS_RowEditing" >
<Columns>
 <asp:ButtonField CommandName="Edit"
  Text="<%$ resources: grdTHISTOPCLS.bbbc8a0b-5bff-4a06-afa6-01327625809b.Text %>"               >
      ...
      HeaderText="<%$ resources: grdTHISTOPCLS.f0820245-0d88-466c-b9f6-6980b134ec22.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Designation"
      HeaderText="<%$ resources: grdTHISTOPCLS.a6cd20c6-36ab-48e9-b120-7a40dd28140e.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="FAMILLE"
      HeaderText="<%$ resources: grdTHISTOPCLS.9a54e2d7-8079-4e4f-98bc-733a1f4f6efb.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Quantite"
      HeaderText="<%$ resources: grdTHISTOPCLS.219bdd12-d3a3-49ae-a648-c88d2d13745b.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Pu_ht"
      HeaderText="<%$ resources: grdTHISTOPCLS.44d8c3bc-244a-4ec9-b5cf-efce3a95d61f.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Ca_ht"
      HeaderText="<%$ resources: grdTHISTOPCLS.708e822c-da0e-47a7-964d-f269be2790aa.ColumnHeading %>"          >
      </asp:BoundField>
...
protected void grdTHISTOPCLSpage_changing(object sender, GridViewPageEventArgs e)
{
 grdTHISTOPCLS.PageIndex = e.NewPageIndex;
 grdTHISTOPCLS.DataBind();
}
...
protected override void OnAddEntityBindings() {
   ...
   dsTHISTOPCLS.BindFieldNames = new String[] { "Id","Date_com","Designation","FAMILLE","Quantite","Pu_ht","Ca_ht" };
