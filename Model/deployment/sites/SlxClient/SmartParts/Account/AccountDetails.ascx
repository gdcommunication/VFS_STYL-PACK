...
<asp:TextBox runat="server" ID="AccountName"  dojoType="Sage.UI.Controls.TextBox" MaxLength="128"  />
 ...
 Text="<%$ resources: ALMAJPV.Caption %>"  />
...
<tr>
 ...
 <div class=" lbl alignleft">
  ...
  <hr />
                ...
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="ALCODEL100_lbl" AssociatedControlID="ALCODEL100" runat="server" Text="<%$ resources: ALCODEL100.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="ALCODEL100" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<asp:TextBox runat="server" ID="BusinessDescription"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
                ...
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="ALDATETRANSFERT_lbl" AssociatedControlID="ALDATETRANSFERT" runat="server" Text="<%$ resources: ALDATETRANSFERT.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="ALDATETRANSFERT" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
                  <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="txtgroupement_lbl" AssociatedControlID="txtgroupement" runat="server" Text="<%$ resources: txtgroupement.Caption %>" ></asp:Label>
 </div>   
   <div  class="textcontrol select"  > 
<asp:ListBox runat="server" ID="txtgroupement"  SelectionMode="Single" Rows="1" data-dojo-type="dijit.form.Select"  CssClass="select-control "  >
</asp:ListBox>
  </div>
...
MaxLength="32" Visible="false"  />
                ...
                <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="WebAddress_lbl" AssociatedControlID="WebAddress" runat="server" Text="<%$ resources: WebAddress.Caption %>" Visible="false" ></asp:Label>
 </div>   
   <div  class="textcontrol"  > 
    <SalesLogix:URL runat="server" ID="WebAddress" ButtonToolTip="<%$ resources: WebAddress.ButtonToolTip %>" Visible="false" URLTextBoxStyle-ForeColor="#000099" URLTextBoxStyle-Font-Underline="false" />
  </div>
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBoxTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("InternalAccountNumber", QFTextBox, "Text");
        ...
        BindingSource.Bindings.Add(ALDATETRANSFERTTextBinding);
          MainEntity.Bindings.Add(new Sage.Platform.Mashups.Web.WebMashupBinding(txtgroupement));
...
ScriptManager.RegisterClientScriptInclude(this, this.GetType(), "31168b30-541f-4d69-a8ad-3a1df7402839", "jscript/Alticap/Alticap.js");
...
public class AccountDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAccountDetails
{
    ...
    private Sage.Platform.Controls.IListBoxControl _txtgroupement;
    public  Sage.Platform.Controls.IListBoxControl txtgroupement
    {
