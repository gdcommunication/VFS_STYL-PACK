...
<tr>
 ...
 <div class=" lbl aligncenter">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox" PickListName="C_TPL_CODECOULEUR" MustExistInList="false" AlphaSort="true" MaxLength="500"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox1" PickListName="C_TPL_CODECOULEUR" MustExistInList="false" AlphaSort="true" MaxLength="500"  />
  </div>
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBoxPickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.COULEURSRECTO", QFTextBox, "PickListValue");
        BindingSource.Bindings.Add(QFTextBoxPickListValueBinding);
                    // QFTextBox1.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox1PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.COULEURSVERSO", QFTextBox1, "PickListValue");
