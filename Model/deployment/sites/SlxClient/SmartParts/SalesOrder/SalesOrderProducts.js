...
,
	   	type: SlxEdit,
		cellValue: SalesOrderProductsgrdItems_Strings['grdItems_a8c6d9fd_1bde_4d02_b2a8_f56adc076935_Text']  || 'Modifier',
		entityType: 'Sage.Entity.Interfaces.ISalesOrderItem, Sage.Entity.Interfaces',
		smartPart: 'EditSalesOrderItem',
		dialogTitle: SalesOrderProductsgrdItems_Strings['f842ee53_0b9f_43c7_858c_57afa8508f76_DialogTitleOverride'] || 'Modifier le produit',
		isCentered: true ,
		dialogTop: 0,
		dialogLeft: 0,
		dialogHeight: 850,
...
,
	   	type: SlxEdit,
		cellValue: SalesOrderProductsgrdItems_Strings['grdItems_3160cbc2_c14d_4e58_94c9_5277e17b3951_Text']  || 'Modifier',
		entityType: 'Sage.Entity.Interfaces.ISalesOrderItem, Sage.Entity.Interfaces',
		smartPart: 'ICEditSalesOrderItem',
		dialogTitle: SalesOrderProductsgrdItems_Strings['0475f9ec_f5ca_4fbd_9241_6d93fbcbdaf7_DialogTitleOverride'] || 'Modifier le produit',
		isCentered: true ,
		dialogTop: 0,
		dialogLeft: 0,
		dialogHeight: 850,
  	...
  	,
{
    ...
    return !isIntegrationContractEnabled();
		...
		name:  SalesOrderProductsgrdItems_Strings['grdItems_eae77157_0570_48d4_bd9a_d78df7b84496_ColumnHeading']  || 'Verrouillé',
	sortable: false,
		width: '10',
	 	styles: 'width:auto;',
    cellClasses: '  aligncenter ',
...
{
		field: 'LineNumber',
				name:  SalesOrderProductsgrdItems_Strings['grdItems_530b7cdb_cef1_4e94_a46a_cf8d931ff779_ColumnHeading']  || 'Ligne N°',
	sortable: true,
		width: 3,
		styles: 'width:auto;',
  																					...
  																					,
{
    ...
    return !isIntegrationContractEnabled();
		...
		name:  SalesOrderProductsgrdItems_Strings['grdItems_ca87da6c_54ec_4780_b7c9_ff6e49313f91_ColumnHeading']  || 'Type de la ligne',
	sortable: true,
		width: 0,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
  	...
  	,
{
    ...
    return !isIntegrationContractEnabled();
		...
		name:  SalesOrderProductsgrdItems_Strings['grdItems_7f13becf_d7b7_41ec_82af_24215aec5077_ColumnHeading']  || 'Type de produit',
	sortable: true,
		width: 0,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
, 
	...
	editable: false
        ...
        storeOptions: {
            ...
            include: ['Product','SalesOrder','UnitOfMeasure'],
            select: ['SalesOrder.ExchangeRate','SalesOrder.CurrencyCode'],
...

{
  ...
  imageClass: 'icon_Save_16x16',  'alternateText' : SalesOrderProductsgrdItems_Strings['grdItems_Save_ToolTip'] || 'Enregistrer',
         'handler' : function() {
...
{
  id : 'luProduct',
  btnToolTip :  SalesOrderProductsluProduct_Strings['luProduct_ButtonTooltip']  ||  'Inclure le produit', 
  btnIcon:  '~/ImageResource.axd?scope=global&type=Global_Images&key=add_products_16x16'  ,
  dialogButtonText : SalesOrderProductsluProduct_Strings['luProduct_DialogButtonText']  ||  'Ajouter sélection', 
  displayMode : 4, //$ {qf control . LookupDisplayMode}  When adding other dijit templates, need to convert control to use enum values
  dialogTitle : SalesOrderProductsluProduct_Strings['luProduct_LookupDialogTitle']  ||  'Rechercher des produits',
      structure : [
     {
	...
	select : ['PackageKitChildViews/ProductId','PackageKitChildViews/ProdPackageKitType','PackageKitChildViews/CommodityType','PackageKitChildViews/Program','PackageKitChildViews/AppId','PackageKitChildViews/Quantity','PackageKitChildViews/ActiveFlag','ProductId','ProdPackageKitType','CommodityType','Program','AppId','Quantity','ActiveFlag']
  },
  gridOptions: {
  ...
  ,
{
  ...
  displayInInsert : true,
  imageClass: 'icon_Delete_16x16',  'alternateText' : SalesOrderProductsgrdItems_Strings['grdItems_Delete_ToolTip'] || 'Retirer',
  ...
  ,
{
  ...
  displayInInsert : false,
  imageClass: 'icon_Reset_16x16',  'alternateText' : SalesOrderProductsgrdItems_Strings['grdItems_Cancel_ToolTip'] || 'Réinitialiser',
