...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFSLXLookup" ToolTip="<%$ resources: QFSLXLookup.ToolTip %>"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFSLXLookup2" ToolTip="<%$ resources: QFSLXLookup2.ToolTip %>"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox2" PickListName="C_TPL_MODEEXPEDITION" CanEditText="false" AlphaSort="true" MaxLength="64"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox3" PickListName="C_TPL_ACTION" CanEditText="false" AlphaSort="true" MaxLength="64"  />
  </div>
...
<div class="slxlabel  alignleft checkboxRight">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="QFTextBox6"  Text="<%$ resources: QFTextBox6.Caption %>"  CssClass=""
...
<asp:TextBox runat="server" ID="QFTextBox5"  Rows="1" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<tr>
            <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="QFTextBox7_lbl" AssociatedControlID="QFTextBox7" runat="server" Text="<%$ resources: QFTextBox7.Caption %>" Visible="false" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFTextBox7"  dojoType="Sage.UI.Controls.TextBox" Visible="false"  />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="QFTextBox8_lbl" AssociatedControlID="QFTextBox8" runat="server" Text="<%$ resources: QFTextBox8.Caption %>" Visible="false" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="QFTextBox8"  dojoType="Sage.UI.Controls.TextBox" Visible="false"  />
  </div>
...
protected override void OnAddEntityBindings() {
        ...
        BindingSource.Bindings.Add(curExtendedPriceTextBinding);
                       // QFSLXLookup.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFSLXLookupTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.COULEURSRECTO", QFSLXLookup, "Text");
        BindingSource.Bindings.Add(QFSLXLookupTextBinding);
                    // QFSLXLookup2.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFSLXLookup2TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.COULEURSVERSO", QFSLXLookup2, "Text");
        BindingSource.Bindings.Add(QFSLXLookup2TextBinding);
                    // QFTextBox2.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox2PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.MODEBAT", QFTextBox2, "PickListValue");
        BindingSource.Bindings.Add(QFTextBox2PickListValueBinding);
                    // QFTextBox3.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox3PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.TYPEBAT", QFTextBox3, "PickListValue");
        BindingSource.Bindings.Add(QFTextBox3PickListValueBinding);
                       // QFTextBox4.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox4TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.NUMEROREPRISEREN", QFTextBox4, "Text");
        BindingSource.Bindings.Add(QFTextBox4TextBinding);
                       // QFTextBox5.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox5TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.COMMENTAIRE", QFTextBox5, "Text");
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox7TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.REMISEGROUPEMENT", QFTextBox7, "Text");
        BindingSource.Bindings.Add(QFTextBox7TextBinding);
                    // QFTextBox8.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox8TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementLigneCommande.REMISELIGNE", QFTextBox8, "Text");
...
protected void QFTextBox6_ChangeAction(object sender, EventArgs e) {
...
// salesOrderItem.ComplementLigneCommande.ECHANTILLON = QFTextBox6.Checked.Equals(true) ? (int)1 : (int)0;
...
QFTextBox6.CheckedChanged += new EventHandler(QFTextBox6_ChangeAction);
...
//    Sage.Entity.Interfaces.ISalesOrderItem salesOrderItem = this.BindingSource.Current as Sage.Entity.Interfaces.ISalesOrderItem;
//    QFTextBox6.Checked = salesOrderItem.ComplementLigneCommande.ECHANTILLON.Equals(null) ? false : (short)salesOrderItem.ComplementLigneCommande.ECHANTILLON.Equals(1) ? true : false;
...
public class EditSalesOrderItemAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IEditSalesOrderItem
{
    ...
    private Sage.Platform.Controls.ITextBoxControl _QFSLXLookup;
    public  Sage.Platform.Controls.ITextBoxControl QFSLXLookup
    {
        get { return FindControl(ref _QFSLXLookup, "QFSLXLookup"); }
    }
    private Sage.Platform.Controls.IPickListControl _QFTextBox2;
    public  Sage.Platform.Controls.IPickListControl QFTextBox2
    {
        get { return FindControl(ref _QFTextBox2, "QFTextBox2"); }
    }
    private Sage.Platform.Controls.ICheckBoxControl _QFTextBox6;
    public  Sage.Platform.Controls.ICheckBoxControl QFTextBox6
    {
    ...
    private Sage.Platform.Controls.ITextBoxControl _QFSLXLookup2;
    public  Sage.Platform.Controls.ITextBoxControl QFSLXLookup2
    {
