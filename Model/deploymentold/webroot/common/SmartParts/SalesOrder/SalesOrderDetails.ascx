...
<tr>
            <td  >
 <asp:Button runat="server" ID="QFCheckBox"
 Text="<%$ resources: QFCheckBox.Caption %>"  />
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox4" PickListName="CompteModereglement" MustExistInList="false" MaxLength="64"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox6" PickListName="CompteModereglement" MustExistInList="false" MaxLength="64"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="QFTextBox8" PickListName="CompteModereglement" MustExistInList="false" MaxLength="64"  />
  </div>
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox1TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.CENTREPAYEUR", QFTextBox1, "Text");
        ...
        BindingSource.Bindings.Add(QFTextBox2TextBinding);
                          // QFTextBox4.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox4PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.MODEREGLEMENT1", QFTextBox4, "PickListValue");
        BindingSource.Bindings.Add(QFTextBox4PickListValueBinding);
                    // QFTextBox5.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox5TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.POURCENTREGLEMENT1", QFTextBox5, "Text");
        BindingSource.Bindings.Add(QFTextBox5TextBinding);
                    // QFTextBox6.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox6PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.MODEREGLEMENT2", QFTextBox6, "PickListValue");
        BindingSource.Bindings.Add(QFTextBox6PickListValueBinding);
                    // QFTextBox7.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox7TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.POURCENTREGLEMENT2", QFTextBox7, "Text");
        BindingSource.Bindings.Add(QFTextBox7TextBinding);
                    // QFTextBox8.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox8PickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.MODEREGLEMENT3", QFTextBox8, "PickListValue");
        BindingSource.Bindings.Add(QFTextBox8PickListValueBinding);
                    // QFTextBox9.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding QFTextBox9TextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ComplementCommande.POURCENTREGLEMENT3", QFTextBox9, "Text");
...
protected void QFCheckBox_ClickAction(object sender, EventArgs e) {
Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
Object[] methodArgs = new Object[] { FormAdapter, e };
lib.Execute("SalesOrderDetails.QFCheckBox_OnClick", methodArgs);
...
QFCheckBox.Click += new EventHandler(QFCheckBox_ClickAction);
...
public class SalesOrderDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.ISalesOrderDetails
{
    ...
    private Sage.Platform.Controls.IButtonControl _QFCheckBox;
    public  Sage.Platform.Controls.IButtonControl QFCheckBox
    {
        get { return FindControl(ref _QFCheckBox, "QFCheckBox"); }
    }
    private Sage.Platform.Controls.IPickListControl _QFTextBox4;
    public  Sage.Platform.Controls.IPickListControl QFTextBox4
    {
    ...
    private Sage.Platform.Controls.IPickListControl _QFTextBox8;
    public  Sage.Platform.Controls.IPickListControl QFTextBox8
    {
    ...
    public  void QFCheckBox_OnClick(System.EventArgs e)
    {
        Sage.Platform.DynamicMethod.DynamicMethodLibrary lib = Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance;
        Object[] methodArgs = new Object[] { this, e };
        lib.Execute("SalesOrderDetails.QFCheckBox_OnClick", methodArgs);
